                                ...
                                <Card.Body>
                                    ...
                                    <Form onSubmit={handleSubmit} className="mx-4">
                                        ...
                                        <FloatingLabel controlId="password" label="Contraseña" className="mb-4 floating-distance-2">
                                           ...
                                           <div onClick={() => setMostrarPassword(!mostrarPassword)}>  {mostrarPassword ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye-fill" viewBox="0 0 16 16">
